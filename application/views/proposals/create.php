...
<div class="ciuis-body-content">
	<div ng-controller="Proposals_Controller" class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
	<?php echo form_open('proposals/add',array("class"=>"form-horizontal proposalForm")); ?>
	<md-toolbar class="toolbar-white">
	  <div class="md-toolbar-tools">
		...
		<md-switch ng-model="proposal_type" aria-label="Type"><strong class="text-muted">FOR LEAD</strong></md-switch>
	...
	<md-content class="bg-white" layout-padding>
        ...
        <md-checkbox class="pull-right" ng-model="comment" aria-label="Comment">
